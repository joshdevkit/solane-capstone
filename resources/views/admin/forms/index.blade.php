                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-gray-100 rounded-lg border-2 border-gray-100 shadow-lg p-4 text-center">
                            <div class="flex items-center justify-center mb-4">
                                ...
                                <h2 class="font-semibold text-lg truncate mr-4">{{ 'Pullout Forms' }}</h2>
                            </div>


                            <a href="{{ route('pullout-forms') }}"
                                class="text-white py-3 px-3 w-54 rounded-lg mt-4 bg-green-600" target="_blank">Create
                                Form</a>
                        ...
                        <div class="bg-gray-100 rounded-lg border-2 border-gray-100 shadow-lg p-4 text-center">
                            <div class="flex items-center justify-center mb-4">
                                ...
                                <h2 class="font-semibold text-lg truncate mr-4">{{ 'Delivery Forms' }}</h2>
                            </div>


                            <a href="{{ route('delivery-forms') }}"
                                class="text-white py-3 px-3 w-54 rounded-lg mt-4 bg-green-600" target="_blank">Create
                                Form</a>
                        ...
                        <div class="bg-gray-100 rounded-lg border-2 border-gray-100 shadow-lg p-4 text-center">
                            <div class="flex items-center justify-center mb-4">
                                ...
                                <h2 class="font-semibold text-lg truncate mr-4">{{ 'Delivery Receipt' }}</h2>
                            </div>
