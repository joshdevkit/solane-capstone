...
@section('title', 'Edit Returns - Sales Info')
        ...
        <div class="w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="text-xl font-bold mb-4">Update Returns</h1>
                    @if ($errors->any())
                        <div class="mb-4">
                    ...
                    @endif
                    <form action="{{ route('returns.update', $returns->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="mb-4">
                                ...
                                <input type="date" name="date_added" id="date_added"
                                    ...
                                    value="{{ old('date_added', $returns->date_added ?? '') }}">
                            </div>
                            <div class="mb-4">
                                ...
                                <input type="text" name="reference_no" id="reference_no"
                                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                                    value="{{ old('reference_no', $returns->reference_no ?? '') }}">
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="mb-4">
                                ...
                                <input type="text" name="biller" id="biller"
                                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                                    value="{{ old('biller', $returns->biller ?? '') }}">
                            </div>
                            <div class="mb-4">
                                ...
                                <select name="customer_id" id="customer_id"
                                    ...
                                    @foreach ($customer as $cust)
                                        <option value="{{ $cust->id }}"
                                            {{ old('customer_id', $returns->customer_id ?? '') == $cust->id ? 'selected' : '' }}>
                                            {{ $cust->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="order_tax" id="order_tax"
                                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                                    value="{{ old('order_tax', $returns->order_tax ?? '') }}">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="discount" id="discount"
                                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                                    value="{{ old('discount', $returns->discount ?? '') }}">
                            </div>
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="text" name="shipping" id="shipping"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                                value="{{ old('shipping', $returns->shipping ?? '') }}">
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                                name="return_notes" rows="3">{{ old('return_notes', $returns->return_notes ?? '') }}</textarea>
                        </div>
                        <div class="mt-6">
                            <button type="submit"
