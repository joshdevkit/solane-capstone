        ...
        <header class="bg-blue-800 shadow fixed w-full z-10">
            <div class="max-w-auto mx-auto py-6 px-4 sm:px-6 lg:px-8 flex items-center">
                ...
                <div class="relative ml-auto">
                    <button type="button" class="flex items-center text-white focus:outline-none mr-4 mt-2"
                    ...
                    <div class="absolute right-0 z-10 hidden mt-2 w-64 bg-white rounded-md shadow-lg"
                        ...
                        <div class="py-1" role="menu" aria-orientation="vertical"
                            ...
                            <ul class="divide-y">
                                ...
                                @empty
                                    <li class="p-4 flex items-center text-center hover:bg-gray-50 cursor-pointer">
                                        <div>
                                            <p class="text-md text-blue-600 leading-4 mt-2">You don't have any
                                                notifications yet.</p>
                                        </div>
                                    </li>
                                @endforelse
